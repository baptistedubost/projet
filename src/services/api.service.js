		...
		routes: [

			{
				...
				aliases: {
					...
					"GET product/:id_product": "produits.get",
					"PATCH product/:id_product": "produits.edit",
					"PATCH product/:id_product/increment": "produits.quantityIncrement",
					"PATCH product/:id_product/decrement": "produits.quantityDecrement",
